...
public class StatementGenerator extends CodeGenerator {
    ...
    public void emitFunctionCall(PascalParser.FunctionCallContext ctx) {
        ...
        if (ctx.getParent() instanceof PascalParser.AssignmentStatementContext) {
            ...
            PascalParser.AssignmentStatementContext assignmentCtx = (PascalParser.Assign
            // entStatementContext) ctx.getParent();
     ...
     * 
     * @param argListCt   the ArgumentListContext.
     *
     */
    private void emitCall(SymtabEntry routineId,
                          PascalParser.ArgumentL
    ...
    private void emitWrite(PascalParser.WriteArgumentsContext argsCtx,
                           boolean needLF) {
            va/lang/System/out", "Ljava/io/PrintStream;");
