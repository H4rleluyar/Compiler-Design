...
public class cpp
{
    public static void main(String[] args) throws Exception
    {
        if (args.length != 2)
        {
            System.out.println("USAGE: cppJava option sourceFileName");
        ...
        cppLexer lexer = new cppLexer(cs);
        ...
        switch (mode)
        {
            case EXECUTOR:
            {
                // Pass 3: Execute the cpp program.
                System.out.printf("\nPASS 3 Execution:\n\n");
            ...
            case COMPILER:
            {
                // Pass 3: Compile the cpp program.
                System.out.printf("\nPASS 3 Compilation: ");
                SymtabEntry programId = pass2.getProgramId();
