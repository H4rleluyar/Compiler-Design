...
public class CodeGenerator
{
     ...
     */
    public void emitComment(cppParser.StatementContext ctx)
    {
...
//        }
    ...
    /**
     * Return a type descriptor for a cpp datatype.
     * @param cppType the datatype.
     * @return the type descriptor.
     */
    public String typeDescriptor(Typespec cppType)
    {
        ...
        {
            buffer.append("[");
            cppType =  cppType.getArrayElementType();
            form = cppType.getForm();
        }
        ...
        else /* (form == RECORD) */ str = "L" + cppType.getRecordTypePath() + ";";
    ...
    /**
     * Return the Java object name for a cpp datatype.
     * @param cppType the datatype.
     * @return the object name.
     */
    public String objectTypeName(Typespec cppType)
    {
        Form form = cppType.getForm();
        StringBuffer buffer = new StringBuffer();
     ...
     */
    public String convertString(String cppString)
    {
