...
public class ExpressionGenerator extends CodeGenerator
{
     ...
     */
    public void emitExpression(cppParser.ExpressionContext ctx)
    {
     ...
     */
    public void emitSimpleExpression(cppParser.SimpleExpressionContext ctx)
    {
     ...
     */
    public void emitTerm(cppParser.TermContext ctx)
    {
     ...
     */
    public void emitNotFactor(cppParser.NotFactorContext ctx)
    {
     ...
     */
    public void emitLoadValue(cppParser.VariableContext varCtx)
    {
        ...
        if (modifierCount > 0)
        {
            cppParser.ModifierContext lastModCtx =
     ...
     */
    public Typespec emitLoadVariable(cppParser.VariableContext varCtx)
    {
        ...
        {
            cppParser.ModifierContext modCtx = varCtx.modifier().get(i);
    ...
    private Typespec emitLoadArrayElementAccess(
                                    cppParser.IndexListContext indexListCtx,
                                    Typespec elmtType, boolean lastModifier)
    {
        ...
        {
            cppParser.IndexContext indexCtx = indexListCtx.index().get(i);
    ...
    private void emitLoadRecordFieldValue(
                        cppParser.FieldContext fieldCtx, Typespec recordType)
    {
     ...
     */
    public void emitLoadIntegerConstant(cppParser.NumberContext intCtx)
    {
     ...
     * @parm intCtx the IntegerConstantContext.
     */
    public void emitLoadRealConstant(cppParser.NumberContext realCtx)
    {
