...
public class ProgramGenerator extends CodeGenerator
{
     ...
     */
    public void emitProgram(cppParser.ProgramContext ctx)
    {
     ...
     */
    private void emitSubroutines(cppParser.RoutinesPartContext ctx)
    {
        if (ctx != null)
        {
            for (cppParser.RoutineDefinitionContext defnCtx :
     ...
     * @param ctx the ProgramContext.
     */
    private void emitMainMethod(cppParser.ProgramContext ctx)
    {
        emitLine();
        emitComment("MAIN");
     ...
     */
    public void emitRoutine(cppParser.RoutineDefinitionContext ctx)
    {
